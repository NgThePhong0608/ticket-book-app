      ...
      ?>
       ...
       <div class="ticket " id="printable">
         ...
         <div class="ticketdesign ticketstructure">
           <h1 align="left"><b>Ticket Booking System</b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Booking ID: <?php echo $row['T_No.'] ?> </h1></span>
           <div class="title"><br>
